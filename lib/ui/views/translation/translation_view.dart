...
class TranslationView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<TranslationViewModel>.reactive(
      viewModelBuilder: () => TranslationViewModel(),
      onModelReady: (TranslationViewModel model) async {
        await model.init();
      },
      builder: (
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        TextAreaWidget(
                                                                          hint:
                                                                              'All your favorites available 0for delivery & pick-up!',
                                                                          lebel:
                                                                              'Description',
                                                                        ),
                                                                        csvertSpace2,
