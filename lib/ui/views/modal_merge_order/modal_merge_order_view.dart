...
import './modal_merge_order_view_model.dart';

class ModalMergeOrderView extends StatelessWidget {
  const ModalMergeOrderView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<ModalMergeOrderViewModel>.reactive(
      viewModelBuilder: () => ModalMergeOrderViewModel(),
      onModelReady: (ModalMergeOrderViewModel model) async {
        await model.init();
      },
      builder: (
        BuildContext context,
        ModalMergeOrderViewModel model,
        Widget? child,
      ) {
        return Scaffold(
          backgroundColor: ccPrimary250,
          body: AlertDialog(
