...
import './translation_item_view_model.dart';

class TranslationItemView extends StatelessWidget {
  const TranslationItemView({super.key});

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<TranslationItemViewModel>.reactive(
      viewModelBuilder: () => TranslationItemViewModel(),
      onModelReady: (TranslationItemViewModel model) async {
        await model.init();
      },
      builder: (
        BuildContext context,
        TranslationItemViewModel model,
        Widget? child,
      ) {
        return Container(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        TranslateTextFeildWidget(
                                                                          hint:
                                                                              'Medium Portion',
                                                                          lebel:
                                                                              'Price definition for 20.00',
                                                                        ),
                                                                        TranslateTextFeildWidget(
                                                                          hint:
                                                                              'Large Portion',
                                                                          lebel:
                                                                              'Price definition for 24.50',
                                                                        ),
                                                                        csvertSpace2,
                                                                      ],
                                                                    ),
