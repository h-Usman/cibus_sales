...
import './translation_modifires_view_model.dart';

class TranslationModifiresView extends StatelessWidget {
  const TranslationModifiresView({super.key});

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<TranslationModifiresViewModel>.reactive(
      viewModelBuilder: () => TranslationModifiresViewModel(),
      onModelReady: (TranslationModifiresViewModel model) async {
        await model.init();
      },
      builder: (
        BuildContext context,
        TranslationModifiresViewModel model,
        Widget? child,
      ) {
        return Container(
