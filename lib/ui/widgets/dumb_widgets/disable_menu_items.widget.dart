...
import 'package:flutter_application_1/ui/widgets/dumb_widgets/disable_prefix_textfeild.widget.dart';
...
class DisableEditMenuItemsWidget extends StatelessWidget {
  final Function? goToPageRequested;
  final Function? goToModalRequested;
  final String menuName;
  final bool status;

  const DisableEditMenuItemsWidget({
    Key? key,
